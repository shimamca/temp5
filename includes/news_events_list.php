...
function deleteMessage(u_id){
	if(confirm("Are you sure to delete this ?")){
		document.location.href="NewsEventsAction.php?act=del&id="+u_id;
	}
}
</script>
 <?php
...
?>
  ...
  <div class="col-12">
  <div class="pull-left"><h4>Article & Events</h4></div>
  ...
  <hr/>
<?php if($total>0) {?>
<form action="NewsEventsAction.php" method="post" >
...
$status = stripslashes($res['oDATA'][$i]['status']);
